        ...
        function() {
            ...
            function t(t, e, i, n, o, a) {
                ...
                return r.save(),
                    ...
                    i = i || 0,
                    n = n || 1,
                    a = a || ht.Default.devicePixelRatio,
                    r.translate(e * a, i * a),
                1 !== (n *= a) && r.scale(n, n),
                o && (r.beginPath(), r.rect(o.x, o.y, o.width, o.height), r.clip(), r.clearRect(o.x, o.y, o.width, o.height)),
                    r
            }
            var e = function t(e) {
            ...
            ht.Default.def(e, ht.ui.drawable.Drawable, {
                ms_ac: ["borderColor"],
                draw: function(t, e, i, n, o, a, r) {
                    var s = this,
                        h = a.getRootContext(r),
                        d = s.getBorderColor();
                    h.beginPath(),
                        h.rect(t, e + n - 1, i, 1),
                        h.fillStyle = d,
                        ...
                        h.fill(),
                        h.beginPath(),
                        ht.Default.drawStretchImage(h, ht.Default.getImage(a.isExpanded() ? "panel_expand": "panel_collapse"), "centerUniform", t + 8, e, 14, n)
                },
            ...
            var i = function t() {
                var i = this;
                t.superClass.constructor.call(this),
                    this.setHeaderBackgroundDrawable(new e("#d8d9d8")),
                    this.setBorder(null),
                    this.setTitleColor("#fff"),
                    this.setCollapsable(!1),
                    this.setHeaderPaddingLeft(28),
                    this.setIconWidth(16),
                    this.setIconHeight(16),
                    this.setExpanded(!1),
                    this.getView().addEventListener("mousedown",
                        function(t) {
            ...
            ht.Default.def(n, ht.ui.ViewGroup, {
                ...
                figurePreferredSize: function() {
                    ...
                    if (e.size() > 0) {
                        var n = e.get(0).getWidth(),
                            o = e.get(0).getHeight(),
                            a = Math.ceil(e.size() * n / this._initWidth);
                        i.height += o * a
                    }
                    return i
                },
                validateImpl: function(t, e, i, n) {
                    for (var o = this,
                             a = o.getVisibleChildren(), r = a.size(), s = t, h = e, d = 0, u = this.getItemHeight(), c = this.getItemWidth(), l = 0; l < r; l++) {
                        var g = a.get(l),
                            f = (g.getPreferredSize(), o.getChildLayoutParams(g) || {}),
                            y = f.marginLeft || 0,
                            v = f.marginRight || 0,
                            p = f.marginTop || 0,
                            x = f.marginBottom || 0;
                        d = Math.max(d, u + p + x),
                        s + c + y + v > t + i && (s = t, h += d, d = 0),
                            o.layoutChild(g, s + y, h + p, c, u),
                            s += y + c + v
                    }
                }
            });
            ...
            o("panel_expand", {
                ...
                o("textBox", {
                    ...
                    comps: [{
                        ...
                        lineHeight: {
                            func: "attr@TBLineHeight",
                            value: 18
                        },
                        background: {
                            func: "attr@TBBackground",
                            value: null
                        },
                        padding: {
                            func: "attr@TBPadding",
                ...
                o("edgeText", {
                    ...
                    comps: [{
                        type: "rect",
                        background: {
                            func: "attr@edge.text.background",
            ...
            ht.Default.def(l, ht.ui.Interactor, {
                handle_mouseenter: function(t) {
                    ht.Default.preventDefault(t),
                        this.getComponent().setState(s.STATE_HOVER)
                },
                handle_mouseleave: function(t) {
                    ht.Default.preventDefault(t),
                        this.getComponent().setState(s.STATE_NORMAL)
                },
                handle_mousedown: function(t) {
                    ...
                    e.forSelect ? c.fire({
                        ...
                        data: e
                    }) : ht.ui.DragHelper.doDrag(e, {},
                        e.getImage(), -e.getWidth() / 2, -e.getHeight() / 2)
                }
            });
            var g = function t() {
                t.superClass.constructor.call(this)
            ...
            ht.Default.def(g, ht.ui.View, {
                ...
                drawBackground: function(t, e, i, n, o, a) {
                    t = this.getCurrentBackgroundDrawable(),
                        g.superClass.drawBackground.call(this, t, e, i, n, o, a)
                },
            ...
            var f = new ht.ui.VBoxLayout; !
                function(t) {
                    h.forEach(function(e) {
                        var o = new i,
                            r = new n(a.SIDBAR_WIDTH);
                        o.setTitle(e.title),
                            o.setTitleColor(a.SIDEBAR_TITLE_TC),
                            o.setTitleFont(a.SIDEBAR_TITLE_TF),
                            o.setExpanded(!0),
                            r.setPadding([0, 0, 10, 0]),
                            r.setItemHeight(50),
                            r.setItemWidth(60),
                            e.graphs.forEach(function(t) {
                                var i = new g;
                                ht.Default.setImage(t, "./symbols/" + t + ".json"),
                                    i.setImage(t),
            ...
            var y = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
                function(t) {
                    return typeof t
                }: function(t) {
                ...
                k = new(function(t) {
                    ...
                    return _(e, w),
                        p(e, [{
                            ...
                            {
                                key: "_resetTabBtnStyle",
                                value: function(t) {
                                    t.setTextColor(a.TAB_BTN_TC),
                                        t.setHoverTextColor(a.TAB_BTN_TC_HOVER),
                                        t.setActiveTextColor(a.TAB_BTN_TC_ACTIVE),
                                        t.setBackground(a.TAB_BTN_BG),
                                        t.setActiveBackground(a.TAB_BTN_BG_ACTIVE),
                                        t.setHoverBackground(a.TAB_BTN_BG_HOVER)
                                }
                            },
                            {
                                key: "addListener",
                ...
                E = (new(function() {
                    ...
                    return p(t, [{
                        ...
                        value: function() {
                            var t = this,
                                e = this.wrap = new ht.ui.RelativeLayout;
                            e.setBackground("#fff");
                    ...
                    },
                        {
                            ...
                            value: function(t) {
                                ...
                                return e.setBackground(null),
                                    e.setActiveBackground("#ebebeb"),
                                    e.setHoverBackground("#ebebeb"),
                                    e.setIconDrawable(new ht.ui.drawable.ImageDrawable(t.icon, "centerUniform", "#111111")),
                                    e.addViewListener(function(e) {
            ...
            var P = "T",
                ...
                L = Math.abs,
                z = Math.max,
                O = ht.Default.getInternal(),
                H = {
                    directionList: [P, B, C, M],
                    getDirection: function(t, e, i, n) {
                        var o = void 0,
                            a = void 0;
                        o = i < .2 ? P: i > .8 ? C: e > .8 ? B: e < .2 ? M: C,
                            a = this.directionList.indexOf(o);
                        var r = n.getRotation();
                        if (r) {
                    ...
                    gen: function(t, e) {
                        var i = this.getSourcePoint(e, t),
                            n = this.getTargetPoint(e, t),
                            o = t.getSourceAgent().getRect(),
                            a = t.getTargetAgent().getRect(),
                            r = t.getSourceAgent(),
                            s = t.getTargetAgent(),
                            ...
                            u = this.points = [];
                        return r === s ? this.genSameImpl(i, n, o, a, h, d) : this.genDiffImpl(i, n, o, a, h, d),
                            this.edge = t,
                            u.unshift(i),
                            u.push(n),
                            new ht.List(u)
                    ...
                    genSameImpl: function(t, e, i, n, o, a) {
                        for (var r = t,
                                 s = this.gatherInfo(a), h = b(s, 2), d = h[0], u = h[1], c = this.gatherInfo(o), l = b(c, 2), g = l[0], f = l[1], y = g === d && u !== f, v = o, p = void 0, x = 0; x < 4; x++) {
                            var _ = this.gatherInfo(v),
                                m = b(_, 2);
                            if (g = m[0], f = m[1], 0 === x) if (p = 26, y) {
                                var w = (this.directionList.indexOf(o) + 3) % this.directionList.length;
                                v = this.directionList[w]
                            } else v = a;
                            else if (1 === x) p = g === R ? .5 * i.width + 26 : .5 * i.height + 26,
                                v = this.getReverseDirection(o);
                            else if (2 === x) if (y) {
                                var T = (this.directionList.indexOf(o) + 1) % this.directionList.length;
                                v = this.directionList[T],
                                    p = (g === R ? i.width: i.height) + 52
                            } else p = L(g === R ? r.x - e.x: r.y - e.y);
                            else if (3 === x) {
                                if (!y) break;
                    ...
                    genDiffImpl: function(t, e, i, n, o, a) {
                        if (!ht.Default.containsPoint(i, e) && !ht.Default.containsPoint(n, t)) {
                            ...
                            do {
                                ...
                                if (u === D) if (r === S) if (h[r] > e[r] && _.t < L(_.o) && d === a) c = h[r] - (e[r] - 26);
                                else if (h[r] > e[r] && d === s && L(x.o) > x.s) {
                                    if (w = !0, 0 === m) c = .5 * L(x.o);
                                    else if (1 === m || 2 === m) {
                                        var N = L(x.o) - x.s;
                                        c = N > 26 ? h[r] - e[r] - 26 : x.s + .5 * N
                                    }
                                } else c = 0 === m && o === s && h[r] > e[r] ? .5 * L(x.o) : 26;
                                else c = (H || V) && h[r] - n[r] - 2 * x.t > 0 && h[r] - n[r] - 2 * x.t <= 34 ? .5 * (h[r] - n[r] - 2 * x.t) : (H || V) && x.o + x.t >= L(x.o) && L(x.o) - x.t >= 8 && L(x.o) - x.t - x.s > 0 ? .5 * (L(x.o) - x.t - x.s) + x.s: (H || V) && x.o + x.t >= 26 && L(x.o) - x.t < 8 ? x.o + 26 + x.t: H || V ? 26 : h[r] - e[r];
                                else if (r === S) if (h[r] < e[r] && _.t < L(_.o) && d === a) c = e[r] - h[r] + 26;
                                else if (h[r] < e[r] && d === s && L(x.o) > x.s) {
                                    if (w = !0, 0 === m) c = .5 * L(x.o);
                                    else if (1 === m || 2 === m) {
                                        var W = L(x.o) - x.s;
                                ...
                                else c = (H || V) && n[r] - h[r] > 0 && n[r] - h[r] <= 34 ? .5 * (n[r] - h[r]) : (H || V) && x.o - x.t <= 26 && L(x.o) - x.t >= 8 && L(x.o) - x.t - x.s > 0 ? .5 * (L(x.o) - x.t - x.s) + x.s: (H || V) && x.o - x.t <= 26 && L(x.o) - x.t < 8 ? x.t + 26 - x.o: H || V ? 26 : e[r] - h[r];
                                if (c = c < 0 ? 26 : c, r === R) if (_.s >= L(_.o) && _.t >= L(_.o) && d === a) d = h.y > e.y ? C: P;
                                else if (0 === m && (V || H) && _.s + _.t + 1.6 >= L(t.y - e.y) && r === S) {
                                    d = h.y > e.y ? C: P;
                                    var G = this.copyPoint(h);
                                    this.move(G, r, u, c),
                                        d = I === A && G.x > e.x || I === D && G.x < e.x ? h.y > e.y ? P: C: h.y > e.y ? C: P
                                } else d = 0 === m && _.s >= L(_.o) && (u === A && h[r] - 2 * x.s >= e[r] || u === D && h[r] <= e[r] - 2 * x.s) ? I === A ? C: P: h.y === e.y && r !== S ? a: h.y > e.y ? P: C;
                                else if (_.s >= L(_.o) && _.t >= L(_.o) && d === a) d = h.x > e.x ? B: M;
                                else if (0 === m && (V || H) && _.s + _.t >= L(t.x - e.x) && r === S) {
                                    var j = this.copyPoint(h);
                                    this.move(j, r, u, c),
                                        d = I === A && j.y > e.y || I === D && j.y < e.y ? h.x > e.x ? M: B: h.x > e.x ? B: M
                                ...
                                if (1 === m && this.getReverseDirection(o) === d && x.s >= c && !w && (c = x.s + 26), 2 === m) {
                                    ...
                                    this.move(q, r, u, c),
                                        this.move(q, F, X, 35),
                                    ht.Default.containsPoint(i, q) && (c = .5 * L(x.o) - x.s > 26 || ht.Default.intersectsRect(i, n) || u === D && h[r] - 2 * x.s - 26 <= e[r] || u === A && h[r] + 2 * x.s + 26 >= e[r] ? 2 * (x.s + 26) : x.s + 26 + .5 * (L(x.o) - 26))
                                }
            ...
            ht.Default.setEdgeType("edgeforflow",
                function(t, e, i, n) {
                    H.gen(t, i);
                    return {
                        points: H.gen(t, i)
            ...
            var V = function() {
                    function t(e, i) {
                        v(this, t),
                        "object" === (void 0 === e ? "undefined": y(e)) && (void 0 != e.x ? (i = e.y, e = e.x) : (i = e[1], e = e[0])),
                            this.set(e || 0, i || 0)
                    }
                    return p(t, [{
                        key: "clone",
                        ...
                        },
                        {
                            ...
                            value: function(e, i) {
                                var n, o;
                                return void 0 === n && (n = new t, o = new t),
                                    n.set(e, e),
                                    o.set(i, i),
                                    this.clamp(n, o)
                            }
                        ...
                        },
                        {
                            ...
                            value: function(t, e) {
                                ...
                                var i = 1 / (this.a * this.d + this.c * -this.b),
                                    n = t.x,
                                    o = t.y;
                                return e.x = this.d * i * n + -this.c * i * o + (this.ty * this.c - this.tx * this.d) * i,
                        ...
                        },
                        {
                            ...
                            value: function(t) {
                                ...
                                return this.a = t.a * e + t.b * n,
                                    ...
                                    this.ty = t.tx * i + t.ty * o + this.ty,
                                    this
                            }
                        },
                        {
                            key: "setTransform",
                            value: function(t, e, i, n, o, a, r, s, h) {
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                return this.a = n / a,
                                    ...
                                    this.c = -i / a,
                                    this.d = t / a,
                                    this.tx = (i * this.ty - n * o) / a,
                                    this.ty = -(t * this.ty - e * o) / a,
                                    this
                            }
                        },
                        {
            ...
            W.toScreenPosition = function(t, e) {
                ...
                W.getDataMatrix = function(t) {
                    if (t instanceof ht.Shape) {
                        var e = new N,
                            i = t.getPosition();
                        return e.translate( - i.x, -i.y).scale(t.getScale().x, t.getScale().y).rotate(t.getRotation()).translate(i.x, i.y),
                            e
                    }
                ...
                W.getDirection = function(t, e, i, n) {
                    var o = void 0,
                        a = void 0,
                        r = ["T", "R", "B", "L"];
                    o = i < .2 ? "T": i > .8 ? "B": e > .8 ? "R": e < .2 ? "L": "B",
                        a = r.indexOf(o);
                    var s = n.getRotation();
                    return s && (o = r[(a + Math.floor((s / (2 * Math.PI) * 360 + 45) / 90)) % r.length]),
                        o
                };
            //顶部编辑器
            var G = {},
            ...
            G.TipHelper = {
                ...
                G.drawIcon = function(t, e, i, n) {
                    i.width = i.height = 1,
                        i.data = n,
                        ht.Default.drawImage(e, i, 0, 0, 1, 1)
                };
            var F = function() {
                    function t() {
                        v(this, t),
                    ...
                    return p(t, [{
                    ...
                    },
                        {
                            key: "setState",
                            value: function(t, e) {
                                if ("object" === (void 0 === t ? "undefined": y(t))) for (var i in t) this._state[i] = t[i];
                                else "string" == typeof t && void 0 !== e && (this._state[t] = e)
                            }
                        },
                        {
                            key: "state",
            ...
            X.prototype.checkIsMe = function(t) {
                ...
                X.prototype.getAnchor2 = function() {
                    ...
                    var n = t._anchor2;
                    return i.getMatrix().tf({
                        x: i.getWidth() * (n.x - i.getAnchor().x),
                        y: i.getHeight() * (n.y - i.getAnchor().y)
                    })
                },
                X.prototype.setAnchor2 = function(t, e) {
                    ...
                    if (n) {
                        ...
                        var r = o.tfi(a);
                        i._anchor2 = {
                            x: n.getAnchor().x + r.x / n.getWidth(),
                            y: n.getAnchor().y + r.y / n.getHeight()
                        }
                    }
                },
                X.prototype.setRotation = function(t) {},
                X.prototype.beginRotate = function(t) {
                    this.rotateCenter = t.pos,
                        this.rotateMode = t.groupRotateMode
                },
                ...
                X.prototype._addRotationInBlockMode = function(t) {
                    var e = this,
                        i = e.rotateCenter || e.getPosition();
                    e._entities.forEach(function(n) {
                        if (e.isNode(n)) {
                            ...
                            n.setRotation(mathAtan2(o.b * a, o.a * a)),
                                n.setPosition(o.tx, o.ty)
                        }
                    })
                },
                    ...
                    e._entities.forEach(function(n) {
                        if (e.isNode(n)) {
                            var o = n.getAnchor(),
                                a = n.getMatrix(),
                                r = a.tf({
                                    x: n.getWidth() * (i.x - o.x),
                                    y: n.getHeight() * (i.y - o.y)
                                }),
                                s = new N;
                            s.set(a.a, a.b, a.c, a.d, a.tx, a.ty),
                                s.translate( - r.x, -r.y),
                                s.rotate(t),
                                s.translate(r.x, r.y);
                            var h = Math.sign(n.getScale().x);
                            n.setRotation(mathAtan2(s.b * h, s.a * h)),
                                n.setPosition(s.tx, s.ty)
                        }
                    })
                },
                X.prototype.setPosition = function(t) {
                    var e = this,
                        ...
                        h = void 0,
                        d = void 0;
                    for (s = 0, h = r.length; s < h; s++) a = r[s],
                    this._isNode(a) && (d = a.getPosition(), a.setPosition(d.x + n, d.y + o));
                    e._position = t
                },
                X.prototype.setScale = function(t, e) {
                    var i = this,
                        n = t / i._scale.x,
                        o = e / i._scale.y;
                    i._adjustChildScaleOrSize(n, o, "size"),
                        i._scale = {
                            x: t,
                            y: e
                        }
                ...
                X.prototype.calcInfo = function() {
                    var t = this,
                        ...
                        h = t._entities,
                        d = t._rotation;
                    for (a = 0, r = h.length; a < r; a++) s = h[a],
                    t.isNode(s) && s.getCorners && o.push.apply(o, s.getCorners());
                    if (o.length) {
                        var u = Math.cos( - d),
                            c = Math.sin( - d),
                            l = 1 / 0,
                            ...
                            f = 1 / 0,
                            y = -1 / 0;
                        for (a = 0, r = o.length; a < r; a++) e = (n = o[a]).x,
                            i = n.y,
                            n.x = u * e - c * i,
                            n.y = c * e + u * i,
                            l = Math.min(l, n.x),
                            ...
                            f = Math.min(f, n.y),
                            y = Math.max(y, n.y);
                        t._width = (g - l) / t._scale.x,
                            t._height = (y - f) / t._scale.y,
                            u = Math.cos(d),
                            c = Math.sin(d);
                        var v = t._anchor;
                        e = l + (g - l) * v.x,
                ...
                X.prototype.draw = function(t, e, i) {
                    var n = this,
                        ...
                        d = void 0,
                        u = void 0;
                    for ("batch" === n.rotateMode && (u = n.getKeyOb()), a = 0, r = o.length; a < r; a++) s = o[a],
                    n.isNode(s) && (h = s.getRect(), d = {
                        min: W.toScreenPosition(i, {
                            x: h.x,
                            y: h.y
                        }),
                        max: W.toScreenPosition(i, {
                            x: h.x + h.width,
                            y: h.y + h.height
                        })
                    },
            ...
            var Z = function(t) {
                ...
                J = function(t) {
                    ...
                    return _(e, F),
                        p(e, [{
                            ...
                            {
                                key: "gatherMultiTargets",
                                value: function(t, e) {
                                    var i = Z(e);
                                    if (!i) return ! 1;
                                    var n = this;
                                    return this.editing || i.calcInfo(),
                                        n.gatherSingleTarget(t, i)
                                }
                            },
                            {
                                key: "check",
                                    ...
                                    if (ht.Default.isLeftButton(e)) {
                                        ...
                                        if (n.editing = null, n.tipInfo = null, n.screenInfo) {
                                            ...
                                            if (o) {
                                                var c = Y.indexOf(o),
                                                    l = $[c],
                                                    g = Math.cos(d.getRotation()),
                                                    f = Math.sin(d.getRotation()),
                                                    y = l.x * Math.sign(d.getScale().x),
                                                    v = l.y * Math.sign(d.getScale().y),
                                                    p = Math.atan2( - f * y - g * v, g * y - f * v),
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    var t = this,
                                        e = t.editing ? t.editing.groupRotateMode: null;
                                    t.editing = null,
                                        t.tipInfo = null,
                                    t._inSmartGuide && (t._interactor.rectGuide.clear(), t._inSmartGuide = !1),
                                    e && t.target && t.target.endRotate()
                                }
                            },
                            {
                                key: "handleEdit",
                                    ...
                                    if (n) {
                                        ...
                                        if ("resize" === l) {
                                            ...
                                            if (i._inSmartGuide && !ht.Default.isCtrlDown(e) && !m) {
                                                var b;
                                                "L" === c || "R" === c ? b = "x": "T" !== c && "B" !== c || (b = "y"),
                                                    i._adsorbedToClosest(a, b),
                                                    d = !0
                                            }
                                            _ = x.tfi(a);
                                            var w;
                                            ...
                                            u.setPosition(T),
                                                u.setSize(f.width, f.height),
                                            d && (r = u.getRect(), g.rectGuide.gatherLines({
                                                    node: u,
                                                    x: r.x,
                                                    y: r.y,
                                                    w: r.width,
                                                ...
                                                b, w)),
                                                o = Math.round(f.width) + " * " + Math.round(f.height)
                                        }
                            ...
                            },
                            {
                                ...
                                value: function(t, e, i) {
                                    ...
                                    n.editDetail || this.gatherInfo(e, i) && n.editType !== s.ET_TEXT && (G.drawIcon(n, t, G.Rect, this.screenInfo), this.tipInfo && G.drawIcon(n, t, G.TipHelper, this.tipInfo))
                                }
                            }]),
                        e
                } (),
                    ...
                    return _(e, F),
                        p(e, [{
                                ...
                                value: function(t, e) {
                                    if (! (e instanceof ht.Edge)) {
                                        var i = this.state.screenInfo = {},
                                            ...
                                            c = new V(d),
                                            l = new V(u),
                                            g = n.rp = c.clone().add(l).divideScalar(2);
                                        g.setY(g.y + r.rotatePointOffset * Math.sin(a) * (1 / s)),
                                            g.setX(g.x + r.rotatePointOffset * Math.cos(a) * (1 / s));
                                        for (var f in n) i[f] = W.toScreenPosition(t, n[f]);
                                        return this.state.target = e,
                                            !0
                                    }
                                }
                            },
                            ...
                            },
                            {
                                ...
                                value: function(t, e, i) {
                                    ...
                                    if (o) {
                                        ...
                                        if (h) {
                                            var c = t.lp(e),
                                                l = this.isGroup(a) ? a.getAnchor2() : a.p();
                                            return d.setCursor("crosshair"),
                                                this.setState({
                                                    editInfo: {
                            ...
                            },
                            {
                                ...
                                value: function(t, e) {
                                    var i = this.state,
                                        ...
                                        a = void 0,
                                        r = void 0,
                                        s = (this._interactor, t.lp(e)),
                                        h = this.isGroup(n) ? n.getAnchor2() : n.p();
                                    a = Math.atan2(s.y - h.y, s.x - h.x) - o.hitRot,
                                        r = o.rotation + a;
                                    var d = Math.PI / 36;
                                    r = Math.round(r / d) * d + .0029229901685084666,
                            ...
                            },
                            {
                                ...
                                value: function(t, e, i) {
                                    var n = this._interactor;
                                    this.state.screenInfo = null,
                                    this.gatherInfo(e, i) && n.editType !== s.ET_TEXT && (G.drawIcon(n, t, G.Rotate, this.state.screenInfo), this.editable && this.drawRotateClock(t))
                                }
                            },
                            {
                                key: "drawRotateClock",
                                value: function(t) {
                                    ...
                                    if (e) {
                                        ...
                                        s = Math.max(s, r.rotateClockMinSize),
                                            t.save(),
                                            t.strokeStyle = "rgba(52, 52,52, 0.6)",
                                            t.lineWidth = 1;
                                        for (var u = 0; u < 72; u++) {
                                            var c = Math.PI / 36 * u,
                                                l = u % 9 ? .93 : 1,
                                                ...
                                                f = s * Math.sin(c);
                                            t.beginPath(),
                                                t.moveTo(g * l + d.x, f * l + d.y),
                                                t.lineTo(.85 * g + d.x, .85 * f + d.y),
                                                t.stroke()
                                        }
                                        t.restore(),
                                        n && (t.save(), t.beginPath(), t.moveTo(d.x, d.y), t.lineTo(d.x, d.y - s), t.arc(d.x, d.y, s, o, a), t.closePath(), t.fillStyle = "rgba(0, 255, 204, 0.7)", t.fill(), t.restore()),
                                            t.save(),
                                            t.beginPath(),
                                            t.fillStyle = "rgba(255, 255, 255, 0.9)",
                                            t.rect(d.x - 25, d.y - 18, 50, 26),
                                            t.fill(),
                                            t.closePath(),
                                            t.restore(),
                                            t.save(),
                ...
                tt = new(function() {
                    function t() {
                        v(this, t);
                        var e = this.box = window.flexBox = new n(a.SIDBAR_WIDTH),
                            i = e.getView();
                        e.setPadding([0, 0, 10, 0]),
                            e.setItemHeight(50),
                            e.setItemWidth(60),
                            i.style.border = "1px solid #999",
                            i.style.boxShadow = "3px 3px 8px #999",
                            i.style.backgroundColor = "#fff",
                            this.box.setVisible(!1)
                    }
                    return p(t, [{
                        key: "show",
                        value: function(t, e) {
                        ...
                        },
                        {
                            ...
                            value: function(t) {
                                if (t) for (var e = 0,
                                                i = h.length; e < i; e++) if (h[e].groupId === t) return h[e];
                                return h[0]
                            }
                        }]),
                        t
                ...
                et = function(t) {
                    function e() {
                        ...
                        return t.addStyleIcon("label", {
                            ...
                            t.a("edge.text.font", t.fontSize + "px arial, sans-serif"),
                            window.te = t,
                            t
                    }
                    return _(e, t),
                        p(e, [{
                            key: "setLabelText",
                            value: function(t, e) {
                                var i = t.getCanvas().getContext("2d"),
                                    n = this.a("edge.text.font"),
                                    o = this.fontSize = parseInt(n.match(/^\d+/g)[0]),
                                    a = this.s("icons"),
                                    r = void 0;
                                i.font = this.a("edge.text.font"),
                                    r = i.measureText(e),
                                    a.label.height = o + 4,
                                    a.label.width = r.width,
                                    this.a("edge.text", e)
                            }
                        },
                            {
                            ...
                            },
                            {
                                ...
                                value: function(t) {
                                    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                                        ...
                                        u = Math.pow,
                                        c = Math.abs,
                                        l = Math.sqrt(u(c(d.x), 2) + u(c(d.y), 2)),
                ...
                ot = function(t) {
                    ...
                    return _(e, F),
                        p(e, [{
                            key: "setUp",
                            value: function() {
                                c.add(this._handleSelectTarget, this),
                                    this._interactor.gv.mi(this._handleClickBackground, this)
                            }
                        },
                            {
                                key: "tearDown",
                                value: function() {
                                    c.remove(this._handleSelectTarget),
                                        this._interactor.gv.umi(this._handleClickBackground)
                                }
                            },
                            {
                                key: "gatherInfo",
                                ...
                                value: function(t, e) {
                                    if (e.getCorners && !(e instanceof ht.Edge)) {
                                        ...
                                        var o = e.getCorners(),
                                            ...
                                            s = new V(o[2]),
                                            h = new V(o[3]);
                                        n.T = a.clone().add(h).divideScalar(2),
                                            n.B = r.clone().add(s).divideScalar(2),
                                            n.L = a.clone().add(r).divideScalar(2),
                                            n.R = h.clone().add(s).divideScalar(2);
                                ...
                                value: function(t, e) {
                                    if (this.editable) {
                                        ...
                                        u.s("2d.visible", !1),
                                            ...
                                            u.setSize(1, 1),
                                            a.add(u),
                                            c.a("source.effective", !0),
                                            c.a("target.effective", !1),
                                            c.a("target.temp", u),
                                            c.s({
                                                "edge.independent": !0,
                                            ...
                                            c.setSource(n),
                                            c.setTarget(u),
                                            c.addStyleIcon("defaultEdgeArrow", {
                                                position: 28,
                                                keepOrien: !0,
                                                width: 10,
                                                height: 12,
                            ...
                            },
                            {
                                ...
                                value: function(t, e, i) {
                                    ...
                                    r.s({
                                        ...
                                        h ? r.setTarget(h) : (r.setTarget(a), a.p(d)),
                                        this.state.hoverNode = h || null,
                                        r.a("target.effective", !!h)
                                }
                            },
                            {
                                key: "endEdit",
                                value: function(t) {
                                    var e = this.state,
                                        i = e.tempNode,
                                        n = e.tempEdge,
                                        o = (e.hoverNode, e.target),
                                        a = e.startLp,
                                        h = this._interactor,
                                        d = h.dm,
                                        u = n.getTarget();
                                    if (u = n.getTarget(), t.distanceTo(a) < r.minDrawEdgeDistance && u === i) return d.remove(i),
                                        d.remove(n),
                                        void this.setState({
                                            tempNode: null,
                                            tempEdge: null,
                            ...
                            },
                            {
                                ...
                                value: function(t) {
                                    if (t.kind === s.SELECT_TARGET) {
                                        ...
                                        i.setImage(o.getImage()),
                                            i.s("2d.visible", !0),
                                            i.s("select.width", 0),
                                            i.a("groupId", o.groupId),
                                        ...
                                        r.setImage("textBox"),
                                            ...
                                            r.a("TBPadding", "5 10"),
                                            i.a("labelComp", r),
                                            this._interactor.dm.add(r),
                                            tt.hide(),
                                            n.a("target.effective", !0),
                                            this.setState({
                                                tempNode: null,
                                                tempEdge: null,
                                                hoverNode: null
                            ...
                            },
                            {
                                ...
                                value: function(t, e, i) {
                                    var n = this._interactor;
                                    this.state.screenInfo = null,
                                    this.gatherInfo(e, i) && n.editType !== s.ET_TEXT && G.drawIcon(n, t, G.EdgePoint, this.state.screenInfo)
                                }
                            }]),
                        e
                } (),
                        ...
                        p(e, [{
                        ...
                        },
                            {
                                ...
                                value: function(t, e) {
                                    var i = this.state.screenInfo = {},
                                        ...
                                        o = e.getSourcePoint(),
                                        a = e.getTargetPoint();
                                    return this.state.editEdge = e,
                                        n.SP = o,
                                        n.TP = a,
                                        i.SP = W.toScreenPosition(t, o),
                                        i.TP = W.toScreenPosition(t, a),
                                        !0
                                }
                            },
                            {
                                ...
                                value: function(t, e) {
                                    if (this.editable) {
                                        var i = this.state,
                                            n = i.editEdge,
                                            o = i.editKey,
                                            a = this._interactor.dm,
                                            r = void 0,
                                            h = o === st ? "source": "target";
                                        n.a(h + ".effective") ? ((r = new ht.Node).s("2d.visible", !1), r.p(t.gv.lp(e)), r.setSize(1, 1), a.add(r), n.a(h + ".temp", r)) : r = o === st ? n.getSource() : n.getTarget(),
                                            o === st ? n.setSource(r) : n.setTarget(r),
                                            this.setState({
                                                tempNode: r
                                            }),
                                            t.startDragging(e),
                            ...
                            },
                            {
                                ...
                                value: function(t, e, i) {
                                    ...
                                    s.s("edge." + d + ".anchor.x", y.x),
                                        s.s("edge." + d + ".anchor.y", y.y),
                                        c ? "SP" === r ? s.setSource(c) : s.setTarget(c) : ("SP" === r ? s.setSource(a) : s.setTarget(a), a.p(l)),
                                        this.state.hoverNode = c || null,
                                        s.a(d + ".effective", !!c)
                                }
                            },
                            {
                                ...
                                value: function(t) {
                                    var e = this.state,
                                        i = e.tempNode,
                                        n = (e.hoverNode, e.editEdge),
                                        o = e.editKey,
                                        a = this._interactor,
                                        r = a.dm; ("SP" === o ? n.getSource() : n.getTarget()) !== i && (r.remove(i), this.setState({
                                        tempNode: null,
                                        editEdge: null,
                                        hoverNode: null
                                    })),
                            ...
                            },
                            {
                                ...
                                value: function(t, e, i) {
                                    var n = this._interactor;
                                    this.state.screenInfo = null,
                                    this.gatherInfo(e, i) && n.editType !== s.ET_TEXT && G.drawIcon(n, t, G.EdgeRect, this.state.screenInfo)
                                }
                            }]),
                        e
                } (),
                        ...
                        p(e, [{
                            ...
                            value: function() {
                                ...
                                t.setAttribute("style", "margin: 0;\n\t\t\t\t\t\t\t\t\t\tpadding: " + r.textareaPadding + "px;\n\t\t\t\t\t\t\t\t\t\toverflow: hidden;\n\t\t\t\t\t\t\t\t\t\tbox-sizing: border-box;\n\t\t\t\t\t\t\t\t\t\tposition: absolute;\n\t\t\t\t\t\t\t\t\t\toutline: none;\n\t\t\t\t\t\t\t\t\t\tresize: none;\n\t\t\t\t\t\t\t\t\t\tborder: node;\n\t\t\t\t\t\t\t\t\t\tborder-width: 0;\n\t\t\t\t\t\t\t\t\t\ttext-align: center;\n\t\t\t\t\t\t\t\t\t\tcursor: inherit;\n\t\t\t\t\t\t\t\t\t\twidth: 100%;\n\t\t\t\t\t\t\t\t\t\tleft: 50%;\n\t\t\t\t\t\t\t\t\t\ttop: 50%;\n\t\t\t\t\t\t\t\t\t\tbackground-color: transparent;"),
                                    t.addEventListener("blur", this._endTextEdit.bind(this)),
                                    t.addEventListener("keydown", this._handleKeyDown.bind(this)),
                                    e.setAttribute("style", "box-sizing:border-box;\n\t\t\t\t\t\t\t\t\tmargin:0;\n\t\t\t\t\t\t\t\t\tpadding:0;\n\t\t\t\t\t\t\t\t\tdisplay: none;\n\t\t\t\t\t\t\t\t\tposition:absolute;\n\t\t\t\t\t\t\t\t\tbox-shadow:0 0 13px rgba(16,142,233, 0.5);\n\t\t\t\t\t\t\t\t\tbackground-color: transparent;"),
                                    e.appendChild(t),
                                    this.gv.getView().appendChild(e);
                                var i = this.input = document.createElement("input");
                                i.text = "text",
                                    i.setAttribute("style", "margin: 0;\n\t\t\t\t\t\t\t\t\t padding: 2px 3px;\n\t\t\t\t\t\t\t\t\t margin-left: -50px;\n\t\t\t\t\t\t\t\t\t width: 100px;\n\t\t\t\t\t\t\t\t\t display: none;\n\t\t\t\t\t\t\t\t\t outline: none;\n\t\t\t\t\t\t\t\t\t position: absolute;\n\t\t\t\t\t\t\t\t\t box-sizing: border-box;\n\t\t\t\t\t\t\t\t\t box-shadow:0 0 13px rgba(16,142,233, 0.5);\n\t\t\t\t\t\t\t\t\t border: 1px solid #d8d8d8;\n\t\t\t\t\t\t\t\t\t text-align: center;"),
                                    this.gv.getView().appendChild(i),
                                    i.addEventListener("blur", this._endTextEdit.bind(this))
                            }
                        },
                            {
                                key: "tearDown",
                                value: function() {
                                    this.gv.umi(this._handleInteractor),
                                        this.gv.getView().removeChild(this.input),
                                        this.gv.getView().removeChild(this.textarea)
                                }
                            },
                            {
                                key: "_handleInteractor",
                                value: function(t) {
                            ...
                            {
                                key: "_createHiddenTextarea",
                                value: function() {
                                    this._hiddenTextarea = document.createElement("textarea"),
                                        this._hiddenTextarea.setAttribute("style", "margin:0; padding:0; position:absolute; overflowY:scroll; resize:none; box-sizing:border-box;"),
                                        this._hiddenTextarea.setAttribute("rows", "1"),
                                        this.gv.getView().appendChild(this._hiddenTextarea)
                                }
                            },
                            {
                                key: "_startTextEdit",
                                value: function(t) {
                                    t.data instanceof ht.Edge ? this._handleEdgeTextEdit(t) : this._handleNodeTextEdit(t),
                                        this._interactor.editType = s.ET_TEXT
                                }
                            },
                            {
                                key: "_handleNodeTextEdit",
                                value: function(t) {
                                    var e = t.data;
                                    this.editTarget = t.data,
                                    this._hiddenTextarea || this._createHiddenTextarea(),
                                        this._textEditingNode = e;
                                    var i = this.wrap,
                                        n = this.textarea,
                                        o = e.a("labelComp"),
                                        a = o.a("TBContent"),
                                    ...
                                    this.nodeHeight = u,
                                        ...
                                        n.style.marginLeft = 0 - .5 * d + "px",
                                    a && (n.value = a, o.s("2d.visible", !1)),
                            ...
                            {
                                key: "_handleEdgeTextEdit",
                                value: function(t) {
                                    var e = this,
                                        i = t.data,
                                        n = this.gv.getDataUI(i)._38o.rects.label[0],
                                        o = W.toScreenPosition(this.gv, {
                                            x: n.x + .5 * n.width,
                                            y: n.y + .5 * n.height
                                        }),
                                        a = this.input.style,
                                    ...
                                    this.editTarget = i,
                                        ...
                                        a.fontSize = s + "px",
                                        a.height = h + "px",
                                        a.marginTop = 0 - .5 * h + "px",
                                    r && (this.input.value = r),
                                        setTimeout(function() {
                                                e.input.focus()
                                            },
                                            10)
                            ...
                            },
                            {
                                ...
                                value: function(t) {
                                    ...
                                    this._interactor.editType = s.ET_NULL,
                                        i.value = ""
                                }
                            },
                            {
                                key: "calculateNodeStyle",
                                value: function(t, e) {
                                    ...
                                    return e && (this.computedStyleCache = r),
                                        r
                                }
                            },
                            {
                                key: "calculateNodeHeight",
                                value: function() {
                                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                                        e = this.textarea,
                                        i = this._hiddenTextarea,
                                        n = this.wrap,
                                        o = this.nodeHeight,
                                        a = this.calculateNodeStyle(e, !1),
                                        r = a.paddingSize,
                                        s = a.borderSize,
                                        h = a.boxSizing,
                                        d = a.sizingStyle;
                                    ...
                                    "border-box" === h ? u += s: "content-box" === h && (u -= r),
                                        e.style.height = u + "px",
                                        e.style.marginTop = 0 - .5 * u + "px",
                                        n.style.height = Math.max(u, o) + "px",
                                        n.style.marginTop = o < u ? .5 * (o - u) + "px": "0"
                                }
                            }]),
                        e
                } (),
                        ...
                        p(e, [{
                                ...
                                value: function(t, e) {
                                    if (this.setState("hoverNode", t || null), t) {
                                        ...
                                        if (i) {
                                            ...
                                            return this.state.editKey = n || null,
                                                !!n
                                        }
                                    }
                                }
                            },
                            {
                                ...
                                value: function(t, e, i) {
                                    ...
                                    this.state.screenInfo = null,
                                    this.gatherInfo(e) && n.editType === s.ET_EDGE && G.drawIcon(n, t, G.EdgePoint, this.state.screenInfo),
                                    o && console.log("画个标识点")
                                }
                            }]),
                        e
                ...
                gt = function(e) {
                    function i(t) {
                        ...
                        return e._notifier = new ht.Notifier,
                            e._subModules = [new ot(e), new Q(e), new J(e), new dt(e), new ct(e), new lt(e)],
                            e
                    }
                    return _(i, e),
                        p(i, [{
                            ...
                            value: function() {
                                var t = this.gv;
                                x(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "setUp", this).call(this),
                                    this.gv.setEditInteractor(this),
                                    this.createEditCanvas(),
                                    this.sm.ms(this._handleSelectModelChange, this),
                                    t.mi(this._handleInteractor, this),
                                    this.dm.onRemoved = this._handleNodeRemove.bind(this),
                                    this.invokeSubModule("setUp", !1),
                                    this._isInputDirty = !1
                            }
                        },
                            {
                                key: "tearDown",
                                value: function() {
                                    var t = this.gv;
                                    x(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "tearDown", this).call(this),
                                        this.sm.ums(this._handleSelectModelChange),
                                        t.umi(this._handleInteractor),
                                        this.dm.onRemoved = function(t) {},
                                        this.invokeSubModule("tearDown", !1)
                                }
                            },
                            {
                                key: "_handleNodeRemove",
                                value: function(t) {
                                    var e = t.a("labelComp");
                                    e && this.dm.remove(e),
                                    t instanceof ht.Edge && (t.a("source.effective") ? t.a("target.effective") || this.dm.remove(t.a("target.temp")) : this.dm.remove(t.a("source.temp")))
                                }
                            },
                            {
                                key: "_handleSelectModelChange",
                                value: function(t) {
                                    this.draw()
                                }
                            },
                            {
                                key: "_handleInteractor",
                                value: function(t) { ["betweenMove", "endMove", "betweenPan", "moveRight", "moveUp", "moveDown", "moveLeft"].indexOf(t.kind) >= 0 && this.draw()
                                }
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function(t) {
                                    ...
                                    e.editing = !1,
                                        e.setCursor("default"),
                                        i.endEdit(this._getLogicalPoint(t)),
                                        e.draw(),
                                        this._editMod = null
                                }
                            },
                ...
                ft = new(function(t) {
                    function e(t) {
                        return v(this, e),
                            m(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this))
                    }
                    return _(e, t),
                        p(e, [{
                            key: "setEditable",
                            value: function(t) {
                                x(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "setEditable", this).call(this, t),
                                    t ? this.setInteractors(new ht.List([new gt(this), new ht.graph.SelectInteractor(this), new ht.graph.MoveInteractor(this), new ht.graph.DefaultInteractor(this), new ht.graph.TouchInteractor(this, {
                                        editable: !1
                                    })])) : this.setInteractors(new ht.List([new ht.graph.DefaultInteractor(this), new ht.graph.SelectInteractor(this)]))
                            }
                        }]),
                        e
                } (ht.graph.GraphView)),
                yt = new ht.widget.RulerFrame(ft),
                vt = new ht.ui.HTView(yt),
                pt = ht.ui.DragHelper,
                xt = yt.getTopRulerConfig(),
                _t = yt.getLeftRulerConfig();
            xt.guideVisible = !0,
                _t.guideVisible = !0,
                ft.setEditable(!0),
                window.gv = ft,
                vt.addViewListener(function(t) {
                    if (t.source instanceof g) if ("dragEnter" === t.kind) pt.acceptDragDrop(t.target);
                    else if ("dragCompleted" === t.kind) {
                        var e = t.source,
                            i = new ht.Node,
                            n = ht.Default.getImage(e.getImage());
                        i.setImage(e.getImage()),
                            i.setWidth(n.width),
                            i.setHeight(n.height),
                            i.p(ft.lp(t.nativeEvent)),
                            i.s("select.width", 0),
                            i.a("groupId", e.groupId);
                        var o = new ht.Node;
                        o.setImage("textBox"),
                            o.setHost(i),
                            o.p(ft.lp(t.nativeEvent)),
                            o.s("2d.selectable", !1),
                            o.a("TBContent", ""),
                            o.a("TBPadding", "5 10"),
                            i.a("labelComp", o),
            ...
            bt.setToggleVisible(!1),
                bt.setSplitter(a.SIDEBAR_BORDER_COLOR),
                bt.setResizable([0, 1, 0, 1]),
                bt.setSplitterSize([1, 4, 0, 4]),
                bt.addView(E, {
                    region: "top",
                    width: "match_parent"
                }),
                E.getView().parentNode.style.zIndex = 100,
                bt.addView(f, {
                    region: "left"
                }),
                bt.setLeftWidth(a.SIDBAR_WIDTH),
                bt.addView(mt, {
                    region: "center"
                }),
                bt.getLeftView().getView().style.backgroundColor = a.SIDEBAR_BG_COLOR,
                window.addEventListener("load",
                    function() {
                        console.log("HT Workflow Editor vv0.0.1 powered by HT for Web v" + ht.Default.getVersion() + " from www.hightopo.com"),
                            bt.addToDOM(),
                            u.fire("load")
                    })
        });
