 ...
 * @return {String}
 */
ht.ui.Column.prototype.getFixed = function() {};


/**
 * 设置锁定方式；锁定列固定显示在表格左侧或右侧，不会跟随横向滚动条滚动
 * @param {String} fixed 'left' 或者 'right'
 */
 ...
 */
ht.ui.View.prototype.setZoom = function(zoom) {}

/**
 * 获取缩放值
 * @return {Number} 缩放值
 */
ht.ui.View.prototype.getZoom = function() {}


/**
 * 设置缩放锚点
 * @param {Array} anchor 横向和纵向锚点数组，如右上角为：[1, 0]
 */
ht.ui.View.prototype.setZoomAnchor = function(anchor) {}

/**
 * 获取缩放锚点
 * @return {Array} 锚点数组
 */
ht.ui.View.prototype.getZoomAnchor = function() {}
/**
 ...
 */
ht.ui.HButtonGroup.prototype.select = function (index){};
 ...
 * @param {Number} index 下标
 */
ht.ui.VButtonGroup.prototype.select = function (index){};
/**
 * 
 ...
 * 	<li> 'absoluteFirst' 左侧区域使用固定宽度或顶部区域使用固定高度，position 指定固定的像素数 </li>
 ...
 * @extends {ht.ui.HBoxLayout}
 * @example
 * inputGroup = new ht.ui.InputGroup();
 * inputGroup.setPrefix('http://www.');
 * var combobox = new ht.ui.ComboBox({datas: ['.com', '.cn', '.com.cn', '.it']});
 * combobox.setReadOnly(true);
 * combobox.setPreferredSize(80, 20);
 * inputGroup.setSuffix(combobox);
 * inputGroup.addToDOM(window, {x: 10, y: 10, width: 300, height: 22});
 * inputGroup.on('p:value', function(e) { // 监听选择事件
 *      console.log(e.newValue);
 * });
 */
ht.ui.InputGroup = function(properties) {};
 ...
 * @return {String} 名称
 */
ht.ui.InputGroup.prototype.getFormDataName = function (){};
 ...
 * @param {String} name 名称
 */
ht.ui.InputGroup.prototype.setFormDataName = function (name){};

/**
 * 获取组件在表单中的值
 * @return {Object} 值
 */
ht.ui.InputGroup.prototype.getFormDataValue = function (){};

/**
 * 获取影响表单值的属性映射表；这些属性发生变化会使表单工具重新从此组件取值
 * @return {Object} 属性映射表
 */
ht.ui.InputGroup.prototype.getFormDataProperties = function (){};

/**
 * 设置前缀，前缀显示在文本框左侧
 * @param {String|ht.ui.View} prefix 设置前缀；如果参数为字符串自动转换为 ht.ui.Label 组件展示
 */
ht.ui.InputGroup.prototype.setPrefix = function (prefix){};

/**
 * 获取前缀
 * @return {String|ht.ui.View} 前缀
 */
ht.ui.InputGroup.prototype.getPrefix = function (){};


/**
 * 设置后缀，前缀显示在文本框右侧
 * @param {String|ht.ui.View} suffix 设置后缀；如果参数为字符串自动转换为 ht.ui.Label 组件展示
 */
ht.ui.InputGroup.prototype.setSuffix = function (suffix){};

/**
 * 获取后缀
 * @return {String|ht.ui.View} 后缀
 */
ht.ui.InputGroup.prototype.getSuffix = function (){};
 ...
 * @return {Object} 文本框值
 */
ht.ui.InputGroup.prototype.getValue = function (){};
 ...
 * @param {Object} value 文本框值
 */
ht.ui.InputGroup.prototype.setValue = function (value){};
/**
 ...
 * </tbody>
 * </table>
 * 样式属性(不含从父类继承)：icon, iconDrawable, hoverIcon, hoverIconDrawable, activeIcon, activeIconDrawable, 
 *  iconWidth, instant, valueField, iconField, displayField, dropDownConfig, datas
 * @param {Object} [properties] 属性配置对象
 * @constructor
 * @extends {ht.ui.RelativeLayout}
 * @example
 * // 只有纯文本的组合框
 * multiSelect = new ht.ui.MultiSelect();
 * multiSelect.setDatas(['HT core', 'HT ContextMenu', 'HT Form']);
 * multiSelect.addToDOM(window, {x: 10, y: 10, width: 160, height: 22});
 * multiSelect.on('p:value', function(e) { // 监听选择事件
 *        console.log(e.newValue);
 *   });
 */
ht.ui.MultiSelect = function(properties) {};
 ...
 * @return {String} 名称
 */
ht.ui.MultiSelect.prototype.getFormDataName = function (){};
 ...
 * @param {String} name 名称
 */
ht.ui.MultiSelect.prototype.setFormDataName = function (name){};

/**
 * 获取组件在表单中的值
 * @return {Object} 值
 */
ht.ui.MultiSelect.prototype.getFormDataValue = function (){};

/**
 * 获取影响表单值的属性映射表；这些属性发生变化会使表单工具重新从此组件取值
 * @return {Object} 属性映射表
 */
ht.ui.MultiSelect.prototype.getFormDataProperties = function (){};

/**
 * 是否是即时模式
 * @return {Boolean} 是否是即时模式
 */
ht.ui.MultiSelect.prototype.isInstant = function (instant){};

/**
 * 设置即时模式
 * @param {Boolean} instant 是否是即时模式
 */
ht.ui.MultiSelect.prototype.setInstant = function (instant){};

/**
 * 获取正常状态下的图标；可以是颜色或者图片等
 * @return {Object} 图标
 * @see {@link ht.ui.MultiSelect#getIconDrawable getIconDrawable}
 */
ht.ui.MultiSelect.prototype.getIcon = function (){};

/**
 * 获取 hover 状态下的图标；可以是颜色或者图片等
 * @return {Object} 图标
 * @see {@link ht.ui.MultiSelect#getHoverIconDrawable getHoverIconDrawable}
 */
ht.ui.MultiSelect.prototype.getHoverIcon = function (){};

/**
 * 获取 active 状态下的图标；可以是颜色或者图片等
 * @return {Object} 图标
 * @see {@link ht.ui.MultiSelect#getActiveIconDrawable getActiveIconDrawable}
 */
ht.ui.MultiSelect.prototype.getActiveIcon = function (){};

/**
 * 获取正常状态下图标的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 图标
 */
ht.ui.MultiSelect.prototype.getIconDrawable = function (){};

/**
 * 获取 hover 状态下的图标的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 图标
 */
ht.ui.MultiSelect.prototype.getHoverIconDrawable = function (){};

/**
 * 获取 active 状态下的图标的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 图标
 */
ht.ui.MultiSelect.prototype.getActiveIconDrawable = function (){};

/**
 * 获取图标的 Drawable 对象；此函数根据当前按钮的状态(normal、hover、active) 返回相应的 Drawable，如：hover 状态下返回 getHoverIconDrawable()
 * @param {String} [state] 状态，如果未指定，使用 multiSelect.getIconState()
 * @return {ht.ui.drawable.Drawable} 图标
 */
ht.ui.MultiSelect.prototype.getCurrentIconDrawable = function (state){};

/**
 * 获取图标宽度
 * @return {Number} 宽度值
 */
ht.ui.MultiSelect.prototype.getIconWidth = function (){};


/**
 * 设置正常状态下的图标
 * @param {Object} icon 图标；可以是颜色或者图片等
 * @see {@link ht.ui.MultiSelect#setIconDrawable setIconDrawable}
 */
ht.ui.MultiSelect.prototype.setIcon = function (icon){};

/**
 * 设置 hover 状态下的图标
 * @param {Object} icon 图标；可以是颜色或者图片等
 * @see {@link ht.ui.MultiSelect#setHoverIconDrawable setHoverIconDrawable}
 */
ht.ui.MultiSelect.prototype.setHoverIcon = function (icon){};

/**
 * 设置 active 状态下的图标
 * @param {Object} icon 图标；可以是颜色或者图片等
 * @see {@link ht.ui.MultiSelect#setActiveIconDrawable setActiveIconDrawable}
 */
ht.ui.MultiSelect.prototype.setActiveIcon = function (icon){};

/**
 * 设置正常状态下图标的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 图标
 */
ht.ui.MultiSelect.prototype.setIconDrawable = function (drawable){};

/**
 * 设置 hover 状态下的图标的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 图标
 */
ht.ui.MultiSelect.prototype.setHoverIconDrawable = function (drawable){};

/**
 * 设置 active 状态下的图标的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 图标
 */
ht.ui.MultiSelect.prototype.setActiveIconDrawable = function (drawable){};

/**
 * 设置图标宽度
 * @param {Number} width 宽度值
 */
ht.ui.MultiSelect.prototype.setIconWidth = function (width){};
 ...
 * @return {Object} 组件值
 */
ht.ui.MultiSelect.prototype.getValue = function (){};

/**
 * 获取数据对象中用于显示的属性，默认为 label
 * @return {String} 属性名
 */
ht.ui.MultiSelect.prototype.getDisplayField = function (){};

/**
 * 设置数据对象中用于显示的属性
 * @param {String} displayField 属性名，默认为 label
 */
ht.ui.MultiSelect.prototype.setDisplayField = function (displayField){};

/**
 * 获取数据对象中的图标属性名，默认为 icon
 * @return {String} 属性名 
 */
ht.ui.MultiSelect.prototype.getIconField = function (){};

/**
 * 设置数据对象中的图标属性名
 * @param {String} iconField 属性名，默认为 icon
 */
ht.ui.MultiSelect.prototype.setIconField = function (iconField){};

/**
 * 获取数据对象中的 id 属性名，默认为 id
 * @return {String} 属性名 
 */
ht.ui.MultiSelect.prototype.getValueField = function (){};

/**
 * 设置数据对象中的 id 属性名；需要注意，默认情况下 multiSelect.getValue() 返回的是数据对象，如果指定了此参数，
 * getValue() 和 setValue() 的返回值和参数都是数据对象中对应的属性
 * @param {String} valueField 属性名，默认为 id
 */
ht.ui.MultiSelect.prototype.setValueField = function (valueField){};

/**
 * 获取当前选中的属性对象数组
 * @return {Array} 属性对象数组
 */
ht.ui.MultiSelect.prototype.getValueObjects = function (){};

/**
 * 设置当前选中的属性对象数组
 * @param {Array} valueObjects 属性对象数组
 */
ht.ui.MultiSelect.prototype.setValueObjects = function (valueObjects){};

/**
 * 获取下拉模板类
 * @return {String|Class} 下拉模板类
 */
ht.ui.MultiSelect.prototype.getDropDownTemplate = function (){};

/**
 * 获取下拉模板属性配置表
 * @return {Object} 属性配置表
 */
ht.ui.MultiSelect.prototype.getDropDownConfig = function (){};

/**
 * 获取下拉数据数组，格式为：[{ id: id1, label: label1, icon: icon1 }, { id: id2, label: label2, icon: icon2 }] 或 [label1, label2, label3]
 * @return {Array} 数据
 */
ht.ui.MultiSelect.prototype.getDatas = function (){};

/**
 * 根据下标选中数据
 * @param {Number} index 下标
 */
ht.ui.MultiSelect.prototype.selectAt = function (index){};
 ...
 * @return {Boolean} 是否处于打开状态
 */
ht.ui.MultiSelect.prototype.isOpened = function() {};

/**
 * 打开下拉框
 */
ht.ui.MultiSelect.prototype.open = function() {};

/**
 * 关闭下拉框
 */
ht.ui.MultiSelect.prototype.close = function() {};

/**
 * 切换下拉框状态(如果处于关闭状态将其打开；如果处于打开状态则将其关闭)
 */
ht.ui.MultiSelect.prototype.toggle = function() {};
 ...
 * @param {Object} value 组件值
 */
ht.ui.MultiSelect.prototype.setValue = function (value){};

/**
 * 设置下拉模板类；这个模板类必须是 ht.ui.DropDownTemplate 的子类，开发者也可以继承这个类实现自己的下拉组件
 * @param {String|Class} template 下拉模板类，如果是字符串，可以使用 $ 加样式名指定外部样式，如：'ht.ui.ListDropDown$myList'
 */
ht.ui.MultiSelect.prototype.setDropDownTemplate = function (template){};

/**
 * 设置下拉模板属性配置表
 * @param {Object} config 属性配置表
 * @example
 * multiSelect.setDropDownConfig({
 * 	'width': 100, // 下拉框宽度
 * 	'height': 100, // 下拉框高度
 * 	'dropDownView.background': 'red' // dropDownView.xxx 用来设置下拉组件的属性
 * });
 */
ht.ui.MultiSelect.prototype.setDropDownConfig = function (config){};

/**
 * 设置下拉数据数组
 * @param {Array} datas 数据数组，格式为：[{ id: id1, label: label1, icon: icon1 }, { id: id2, label: label2, icon: icon2 }] 或 [label1, label2, label3]
 */
ht.ui.MultiSelect.prototype.setDatas = function (datas){};
 ...
 *                      headerTitleColor, hoverHeaderTitleColor, weekTitleColor, gridColor, otherMonthGridColor, hoverGridColor, selectGridColor, disabledGridColor, timeAlign, timeColor, hoverTimeColor, disabledTimeColor, 
 *                      hoverGridBackground, hoverGridBackgroundDrawable, selectGridBackground, selectGridBackgroundDrawable, selectableFunc
 * @param {Object} [properties] 属性配置对象
 * @constructor
 * @extends {ht.ui.View}
 */
 ...
 * @return {Function} 
 */
ht.ui.DateTimePane.prototype.getSelectableFunc = function (){};

/**
 * 设置选中过滤器函数
 * @param {Function} func 选中过滤器函数，如只允许选中今天之后的日期：dateTimePane.setSelectableFunc(function(date) { return date > new Date() })
 */
ht.ui.DateTimePane.prototype.setSelectableFunc = function (func){};
...
/**
 * 获取禁用(不可选中)状态的日期网格文字颜色
 * @return {color} 颜色值
 */
ht.ui.DateTimePane.prototype.getDisabledGridColor = function (){};

/**
 * 设置禁用(不可选中)状态的日期网格文字颜色
 * @param {color} color 颜色值
 */
ht.ui.DateTimePane.prototype.setDisabledGridColor = function (color){};
 ...
 */
ht.ui.DateRangeDropDown.prototype.setShortcuts = function (shortcuts){};
...
/**
 * 获取颜色值在下拉框中的显示方式
 * @return {String} 颜色值的显示方式
 */
ht.ui.ColorPicker.prototype.getValueMode = function (){};

/**
 * 设置颜色值在下拉框中的显示方式
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.ColorPicker.prototype.setValueMode = function (mode){};
/**
 ...
 *       visibleFunc, autoMakeVisible, rowBackground, rowBackgroundDrawable, selectRowBackground, selectRowBackgroundDrawable, hoverRowBackground, hoverRowBackgroundDrawable, focusRowBackground, focusRowBackgroundDrawable,
 ...
 * @param {ht.Data} data 要选中的数据行
 */
ht.ui.ListView.prototype.handleSelect = function (e, data){};
 ...
 * 获取行选中背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.ListView#getSelectRowBackgroundDrawable getSelectRowBackgroundDrawable}
 */
ht.ui.ListView.prototype.getSelectRowBackground = function (){};

/**
 * 获取行选中背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.ListView.prototype.getSelectRowBackgroundDrawable = function (){};

/**
 * 获取 hover 状态下的行背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.ListView#getHoverRowBackgroundDrawable getHoverRowBackgroundDrawable}
 */
ht.ui.ListView.prototype.getHoverRowBackground = function (){};

/**
 * 获取 hover 状态下行选中背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.ListView.prototype.getHoverRowBackgroundDrawable = function (){};
 ...
 * 设置行选中背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.ListView#setSelectRowBackgroundDrawable setSelectRowBackgroundDrawable}
 */
ht.ui.ListView.prototype.setSelectRowBackground = function (background){};

/**
 * 设置行选中背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.ListView.prototype.setSelectRowBackgroundDrawable = function (drawable){};

/**
 * 设置 hover 状态下的行背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.ListView#setHoverRowBackgroundDrawable setHoverRowBackgroundDrawable}
 */
ht.ui.ListView.prototype.setHoverRowBackground = function (background){};

/**
 * 设置 hover 状态下行选中背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.ListView.prototype.setHoverRowBackgroundDrawable = function (drawable){};
 ...
 * @return {Object} 背景
 * @see {@link ht.ui.ListView#getFocusRowBackgroundDrawable getFocusRowBackgroundDrawable}
 */
ht.ui.ListView.prototype.getFocusRowBackground = function (){};

/**
 * 获取 check 模式下，点击行背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.ListView.prototype.getFocusRowBackgroundDrawable = function (){};


/**
 * 设置 check 模式下，点击行的背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.ListView#setFocusRowBackgroundDrawable setFocusRowBackgroundDrawable}
 */
ht.ui.ListView.prototype.setFocusRowBackground = function (background){};

/**
 * 设置 check 模式下，点击行背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.ListView.prototype.setFocusRowBackgroundDrawable = function (drawable){};

/**
 * 获取行背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.ListView#getRowBackgroundDrawable getRowBackgroundDrawable}
 */
ht.ui.ListView.prototype.getRowBackground = function (){};

/**
 * 获取行背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.ListView.prototype.getRowBackgroundDrawable = function (){};

/**
 * 设置行背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.ListView#setRowBackgroundDrawable setRowBackgroundDrawable}
 */
ht.ui.ListView.prototype.setRowBackground = function (background){};

/**
 * 设置行背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.ListView.prototype.setRowBackgroundDrawable = function (drawable){};
/**
 ...
 *       autoMakeVisible, rowBackground, rowBackgroundDrawable, selectRowBackground, selectRowBackgroundDrawable, hoverRowBackground, hoverRowBackgroundDrawable, focusRowBackground, focusRowBackgroundDrawable,
 ...
 * @param {ht.Data} data 要选中的数据行
 */
ht.ui.TableView.prototype.handleSelect = function (e, data){};
 ...
 * 获取行选中背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.TableView#getSelectRowBackgroundDrawable getSelectRowBackgroundDrawable}
 */
ht.ui.TableView.prototype.getSelectRowBackground = function (){};

/**
 * 获取行选中背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TableView.prototype.getSelectRowBackgroundDrawable = function (){};

/**
 * 获取 hover 状态下的行背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.TableView#getHoverRowBackgroundDrawable getHoverRowBackgroundDrawable}
 */
ht.ui.TableView.prototype.getHoverRowBackground = function (){};

/**
 * 获取 hover 状态下行选中背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TableView.prototype.getHoverRowBackgroundDrawable = function (){};
 ...
 * 设置行选中背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.TableView#setSelectRowBackgroundDrawable setSelectRowBackgroundDrawable}
 */
ht.ui.TableView.prototype.setSelectRowBackground = function (background){};

/**
 * 设置行选中背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.TableView.prototype.setSelectRowBackgroundDrawable = function (drawable){};

/**
 * 设置 hover 状态下的行背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.TableView#setHoverRowBackgroundDrawable setHoverRowBackgroundDrawable}
 */
ht.ui.TableView.prototype.setHoverRowBackground = function (background){};

/**
 * 设置 hover 状态下行选中背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.TableView.prototype.setHoverRowBackgroundDrawable = function (drawable){};
 ...
 * 获取 check 模式下，点击行的背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.TableView#getFocusRowBackgroundDrawable getFocusRowBackgroundDrawable}
 */
ht.ui.TableView.prototype.getFocusRowBackground = function (){};

/**
 * 获取 check 模式下，点击行背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TableView.prototype.getFocusRowBackgroundDrawable = function (){};


/**
 * 设置 check 模式下，点击行的背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.TableView#setFocusRowBackgroundDrawable setFocusRowBackgroundDrawable}
 */
ht.ui.TableView.prototype.setFocusRowBackground = function (background){};

/**
 * 设置 check 模式下，点击行背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.TableView.prototype.setFocusRowBackgroundDrawable = function (drawable){};


/**
 * 获取行背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.TableView#getRowBackgroundDrawable getRowBackgroundDrawable}
 */
ht.ui.TableView.prototype.getRowBackground = function (){};

/**
 * 获取行背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TableView.prototype.getRowBackgroundDrawable = function (){};

/**
 * 设置行背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.TableView#setRowBackgroundDrawable setRowBackgroundDrawable}
 */
ht.ui.TableView.prototype.setRowBackground = function (background){};

/**
 * 设置行背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.TableView.prototype.setRowBackgroundDrawable = function (drawable){};
/**
 ...
 *           rowBackground, rowBackgroundDrawable, selectRowBackground, selectRowBackgroundDrawable, focusRowBackground, focusRowBackgroundDrawable, rowHeightFunc,
 ...
 * @param {ht.Data} data 要选中的数据行
 */
ht.ui.TreeView.prototype.handleSelect = function (e, data){};
 ...
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TreeView.prototype.getCurrentRowBackgroundDrawable = function(data, selected) {};
 ...
 * 获取行选中背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.TreeView#getSelectRowBackgroundDrawable getSelectRowBackgroundDrawable}
 */
ht.ui.TreeView.prototype.getSelectRowBackground = function (){};

/**
 * 获取行选中背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TreeView.prototype.getSelectRowBackgroundDrawable = function (){};

/**
 * 获取 hover 状态下的行背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.TreeView#getHoverRowBackgroundDrawable getHoverRowBackgroundDrawable}
 */
ht.ui.TreeView.prototype.getHoverRowBackground = function (){};

/**
 * 获取 hover 状态下行选中背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TreeView.prototype.getHoverRowBackgroundDrawable = function (){};
 ...
 * 设置行选中背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.TreeView#setSelectRowBackgroundDrawable setSelectRowBackgroundDrawable}
 */
ht.ui.TreeView.prototype.setSelectRowBackground = function (background){};

/**
 * 设置行选中背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.TreeView.prototype.setSelectRowBackgroundDrawable = function (drawable){};

/**
 * 设置 hover 状态下的行背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.TreeView#setHoverRowBackgroundDrawable setHoverRowBackgroundDrawable}
 */
ht.ui.TreeView.prototype.setHoverRowBackground = function (background){};

/**
 * 设置 hover 状态下行选中背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.TreeView.prototype.setHoverRowBackgroundDrawable = function (drawable){};
 ...
 * 获取 check 模式下，点击行的背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.TreeView#getFocusRowBackgroundDrawable getFocusRowBackgroundDrawable}
 */
ht.ui.TreeView.prototype.getFocusRowBackground = function (){};

/**
 * 获取 check 模式下，点击行背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TreeView.prototype.getFocusRowBackgroundDrawable = function (){};


/**
 * 设置 check 模式下，点击行的背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.TreeView#setFocusRowBackgroundDrawable setFocusRowBackgroundDrawable}
 */
ht.ui.TreeView.prototype.setFocusRowBackground = function (background){};

/**
 * 设置 check 模式下，点击行背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.TreeView.prototype.setFocusRowBackgroundDrawable = function (drawable){};


/**
 * 获取行背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.TreeView#getRowBackgroundDrawable getRowBackgroundDrawable}
 */
ht.ui.TreeView.prototype.getRowBackground = function (){};

/**
 * 获取行背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TreeView.prototype.getRowBackgroundDrawable = function (){};

/**
 * 设置行背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.TreeView#setRowBackgroundDrawable setRowBackgroundDrawable}
 */
ht.ui.TreeView.prototype.setRowBackground = function (background){};

/**
 * 设置行背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.TreeView.prototype.setRowBackgroundDrawable = function (drawable){};
/**
 ...
 *           columnLineVisible, columnLineColor, rowBackground, rowBackgroundDrawable, selectRowBackground, selectRowBackgroundDrawable
 *           expandIcon, expandIconDrawable, collapseIcon, collapseIconDrawable,
 *           hoverExpandIcon, hoverExpandIconDrawable, hoverCollapseIcon, hoverCollapseIconDrawable,
 *           selectExpandIcon, selectExpandIconDrawable, selectCollapseIcon, selectCollapseIconDrawable,
 *           rowHeightFunc,
 *           hoverRowBackground, hoverRowBackgroundDrawable, focusRowBackground, focusRowBackgroundDrawable, iconWidth, iconHeight, iconGap,
 ...
 * @param {ht.Data} data 要选中的数据行
 */
ht.ui.TreeTableView.prototype.handleSelect = function (e, data){};
 ...
 * 获取行选中背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.TreeTableView#getSelectRowBackgroundDrawable getSelectRowBackgroundDrawable}
 */
ht.ui.TreeTableView.prototype.getSelectRowBackground = function (){};

/**
 * 获取行选中背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TreeTableView.prototype.getSelectRowBackgroundDrawable = function (){};

/**
 * 获取 hover 状态下的行背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.TreeTableView#getHoverRowBackgroundDrawable getHoverRowBackgroundDrawable}
 */
ht.ui.TreeTableView.prototype.getHoverRowBackground = function (){};

/**
 * 获取 hover 状态下行选中背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TreeTableView.prototype.getHoverRowBackgroundDrawable = function (){};
 ...
 * 设置行选中背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.TreeTableView#setSelectRowBackgroundDrawable setSelectRowBackgroundDrawable}
 */
ht.ui.TreeTableView.prototype.setSelectRowBackground = function (background){};

/**
 * 设置行选中背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.TreeTableView.prototype.setSelectRowBackgroundDrawable = function (drawable){};

/**
 * 设置 hover 状态下的行背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.TreeTableView#setHoverRowBackgroundDrawable setHoverRowBackgroundDrawable}
 */
ht.ui.TreeTableView.prototype.setHoverRowBackground = function (background){};

/**
 * 设置 hover 状态下行选中背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.TreeTableView.prototype.setHoverRowBackgroundDrawable = function (drawable){};
 ...
 * 获取 check 模式下，点击行的背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.TreeTableView#getFocusRowBackgroundDrawable getFocusRowBackgroundDrawable}
 */
ht.ui.TreeTableView.prototype.getFocusRowBackground = function (){};

/**
 * 获取 check 模式下，点击行背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TreeTableView.prototype.getFocusRowBackgroundDrawable = function (){};


/**
 * 设置 check 模式下，点击行的背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.TreeTableView#setFocusRowBackgroundDrawable setFocusRowBackgroundDrawable}
 */
ht.ui.TreeTableView.prototype.setFocusRowBackground = function (background){};

/**
 * 设置 check 模式下，点击行背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.TreeTableView.prototype.setFocusRowBackgroundDrawable = function (drawable){};


/**
 * 获取行背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.TreeTableView#getRowBackgroundDrawable getRowBackgroundDrawable}
 */
ht.ui.TreeTableView.prototype.getRowBackground = function (){};

/**
 * 获取行背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.TreeTableView.prototype.getRowBackgroundDrawable = function (){};

/**
 * 设置行背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.TreeTableView#setRowBackgroundDrawable setRowBackgroundDrawable}
 */
ht.ui.TreeTableView.prototype.setRowBackground = function (background){};

/**
 * 设置行背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.TreeTableView.prototype.setRowBackgroundDrawable = function (drawable){};
/**
 ...
 *       expandIcon, expandIconDrawable, collapseIcon, collapseIconDrawable,
 *       rowBackground, rowBackgroundDrawable,
 *       selectRowBackground, selectRowBackgroundDrawable, indentBackground, indentBackgroundDrawable,
 *       iconWidth, iconHeight,
 *       hoverRowBackground, hoverRowBackgroundDrawable,
 ...
 * 获取行选中背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.PropertyView#getSelectRowBackgroundDrawable getSelectRowBackgroundDrawable}
 */
ht.ui.PropertyView.prototype.getSelectRowBackground = function (){};

/**
 * 获取行选中背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.PropertyView.prototype.getSelectRowBackgroundDrawable = function (){};

/**
 * 获取 hover 状态下的行背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.PropertyView#getHoverRowBackgroundDrawable getHoverRowBackgroundDrawable}
 */
ht.ui.PropertyView.prototype.getHoverRowBackground = function (){};
 ...
 * 设置行选中背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.PropertyView#setSelectRowBackgroundDrawable setSelectRowBackgroundDrawable}
 */
ht.ui.PropertyView.prototype.setSelectRowBackground = function (background){};

/**
 * 设置行选中背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.PropertyView.prototype.setSelectRowBackgroundDrawable = function (drawable){};

/**
 * 设置 hover 状态下的行背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.PropertyView#setHoverRowBackgroundDrawable setHoverRowBackgroundDrawable}
 */
ht.ui.PropertyView.prototype.setHoverRowBackground = function (background){};

/**
 * 设置 hover 状态下行选中背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.PropertyView.prototype.setHoverRowBackgroundDrawable = function (drawable){};
 ...
 * 获取行背景；可以是颜色或者图片等
 * @return {Object} 背景
 * @see {@link ht.ui.PropertyView#getRowBackgroundDrawable getRowBackgroundDrawable}
 */
ht.ui.PropertyView.prototype.getRowBackground = function (){};

/**
 * 获取行背景的 Drawable 对象
 * @return {ht.ui.drawable.Drawable} 背景
 */
ht.ui.PropertyView.prototype.getRowBackgroundDrawable = function (){};

/**
 * 设置行背景；可以是颜色或者图片等
 * @param {Object} background 背景
 * @see {@link ht.ui.PropertyView#setRowBackgroundDrawable setRowBackgroundDrawable}
 */
ht.ui.PropertyView.prototype.setRowBackground = function (background){};

/**
 * 设置行背景的 Drawable 对象
 * @param {ht.ui.drawable.Drawable} drawable 背景
 */
ht.ui.PropertyView.prototype.setRowBackgroundDrawable = function (drawable){};
/**
