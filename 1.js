    ...
    function(e, t) {
        ...
        function() {
            ...
            n.add(r),
                ...
                r.a("nodeType", 2),
                r.setName("文本"),
                r.s("image.stretch", "centerUniform");
            var d = new ht.Node;
            n.add(d),
                d.setParent(i),
                d.s("draggable", !0),
                d.a("nodeType", 1),
                d.setName("节点"),
                d.s("image.stretch", "centerUniform");
            var l = new ht.Node;
            n.add(l),
                l.setParent(i),
                l.s("draggable", !0),
                l.setImage("group_image"),
                l.a("nodeType", 3),
                l.setName("组"),
                l.s("image.stretch", "centerUniform"),
                a.setName("注册图片"),
                a.setExpanded(!0),
                t.forEach(function(e) {
                    var t = new ht.Node;
                    t.setImage("./symbols/device/" + e + ".json"),
                        n.add(t),
                        t.setParent(a),
                        t.a("type", 2),
                        t.s("draggable", !0),
                        t.a("nodeType", 1),
                        t.s("image.stretch", "centerUniform")
                }),
                n.add(a),
                s.setName("默认形状"),
                n.add(s),
                o.setItemImageHeight(62),
                o.setItemImageWidth(52);
            var c = {
                    view: o
                },
            ...
            p.style.background = "#fff",
                p.style.border = "1px solid rgb(240, 239, 238)";
            h.dm();
            e.globalEvent.add(function(e) {
                ...
                h.getView().addEventListener("dragover",
                    function(e) {
                        e.preventDefault(),
                            e.dataTransfer.dropEffect = "copy"
                    });
            var u = 1;
            h.getView().addEventListener("drop",
                function(e) {
                    e.preventDefault(),
                        e.stopPropagation();
                    ...
                    if (t) {
                        var i = t.a("nodeType");
                        2 === i ? (console.log("text"), (o = new ht.Text).setDisplayName(t.getDisplayName())) : 1 === i ? ((o = new ht.Node).setName("node" + u++), o.setImage(t.getImage())) : 3 === i && (o = new ht.Group),
            ...
            ht.Default.def(m, ht.graph.Interactor, {
                ...
                tearDown: function() {
                    m.superClass.tearDown.call(this),
                ...
                handle_touchstart: function(t) {
                    e.globalEvent.fire({
                        ...
                        this._sourceNode = this.getNodeAt(t),
                    this._sourceNode && (this._targetNode = null, this.startDragging(t), this._graphView.addTopPainter(this), this._graphView.getSelectionModel().setSelection(this._sourceNode))
                },
                ...
                handleWindowTouchMove: function(e) {
                    ...
                    this.redraw(),
                        ...
                        this._targetNode ? t.getSelectionModel().setSelection([this._sourceNode, this._targetNode]) : t.getSelectionModel().setSelection([this._sourceNode]),
                        this.redraw()
                },
                handleWindowTouchEnd: function(t) {
                    if (e.globalEvent.fire({
                        ...
                        o.setParent(this._graphView.getCurrentSubGraph()),
                            this._graphView.getDataModel().add(o),
                            this._graphView.getSelectionModel().setSelection(o),
                        this._edgeType && o.s("edge.type", this._edgeType)
                    }
            ...
            ht.Default.def(y, ht.graph.Interactor, {
                ...
                tearDown: function() {
                    y.superClass.tearDown.call(this),
                        this._graphView.removeTopPainter(this),
                        ...
                        if (this.redraw(), ht.Default.isDoubleClick(e)) {
                            if (this._points.size() > 1) {
                                ...
                                o.setPoints(this._points),
                                    o.setParent(t.getCurrentSubGraph()),
                                    t.getDataModel().add(o),
                ...
                draw: function(e) {
                    ...
                    if (t > 0) {
                        ...
                        e.lineWidth = 1,
                            ...
                            e.beginPath(),
                            e.moveTo(o.x, o.y);
                        for (var n = 1; n < t; n++) o = this._points.get(n),
                            e.lineTo(o.x, o.y);
                        for (this._movePoint && e.lineTo(this._movePoint.x, this._movePoint.y), e.stroke(), n = 0; n < t; n++) o = this._points.get(n),
                            e.fillStyle = "white",
                            e.strokeStyle = "#34495E",
                            e.lineWidth = 1,
                            e.beginPath(),
                            e.arc(o.x, o.y, 4, 0, 2 * Math.PI, !0),
                            e.fill(),
                            e.stroke()
                    }
                }
            ...
            w.setVGap(0),
                ...
                w.addRow(["", {
                ...
                },
                    {
                        button: {
                            background: "#fff",
                            icon: "./symbols/icon/zoom-in.json",
                            iconColor: b,
                            selectBackground: T,
                            toolTip: "放大",
                            onClicked: function() {
                    ...
                    },
                    {
                        button: {
                            background: "#fff",
                            icon: "./symbols/icon/zoom-out.json",
                            iconColor: b,
                            selectBackground: T,
                            toolTip: "缩小",
                            onClicked: function() {
                    ...
                    },
                    {
                        button: {
                            background: "#fff",
                            icon: "./symbols/icon/proportion.json",
                            iconColor: b,
                            selectBackground: T,
                            toolTip: "1:1",
                            onClicked: function() {
                    ...
                    },
                    {
                        button: {
                            background: "#fff",
                            icon: "./symbols/icon/full-screen.json",
                            iconColor: b,
                            selectBackground: T,
                            toolTip: "纵览",
                            onClicked: function() {
                    ...
                    },
                    {
                        button: {
                            background: "#fff",
                            icon: "./symbols/icon/broken-line.json",
                            iconColor: b,
                            selectBackground: T,
                            togglable: !0,
                            groupId: "t",
                    ...
                    "", {
                        button: {
                            ...
                            onClicked: function() {
                                ...
                                e.open(),
                                    e.write("<pre>" + _.dm().serialize() + "</pre>"),
                                    e.close(),
                                    e.body.style.margin = "0",
                                    e.title = "Export JSON at " + new Date
                            }
                        }
                    },
            ...
            C.prototype.init = function(e) {
                ...
                o.setHPadding(0),
                    o.setVPadding(0),
                    o.setVGap(0),
                    o.getView().style.display = "none",
                    this._categoryInfo = [],
                    this.elements = [],
                    this.formMap = {},
                    this.vGap = 6,
                    this.addCatygory("__node", "节点"),
                ...
                C.prototype._addCatygoryToRoot = function() {
                    ...
                    for (var t in this.formMap) {
                        ...
                        this.root.addRow([this.formMap[t]], [.1], o),
                            this.formMap[t].__rowIndex = e,
                            this._categoryInfo[e].isExpand = !0,
                            this._categoryInfo[e].expandHeight = o,
                            e++
                    }
                },
                ...
                C.prototype._addListener = function() {
                    ...
                    e && e.globalEvent.add(function(e) {
                        ...
                        this._gv.sm().ms(function(e) {
                            if (!t.disable) {
                                var o = t._gv.sm().ld();
                                t._selectedNode = o || null,
                                    o && o instanceof ht.Node ? (t.root.getView().style.display = "block", t.root.iv(), t.countOffsetTop(), t._setNodeInfoToForm(o)) : t.root.getView().style.display = "none"
                            }
                        }),
                ...
                C.prototype.countOffsetTop = function() {
                    if (!this.hasOwnProperty("_offsetTop")) {
                        for (var e = this.root.getView(), t = 0;;) if (t += e.offsetTop, !(e = e.parentNode) || void 0 === e.offsetTop) break;
                        this._offsetTop = t,
                            console.log(t)
                    }
                },
                ...
                C.prototype.createElement = function(e) {
                    ...
                    switch (o) {
                        ...
                        case C.COMBO_BOX:
                            var l = a[0],
                                c = a[1] || a[0]; (s = new ht.widget.ComboBox).setValues(l),
                            s.setLabels(c);
                            break;
                        case C.NUMBER:
                            (s = new ht.widget.TextField).getElement().addEventListener("propertychange", d),
                                s.getElement().addEventListener("input", d);
                            break;
                        case C.INT:
                            (s = new ht.widget.TextField).getElement().addEventListener("propertychange", r),
                                s.getElement().addEventListener("input", r);
                            break;
                        default:
                            s = new ht.widget.TextField
                    }
                    return this.elements.push({
                        ...
                        o === C.TEXT || o === C.NUMBER || o === C.INT ? (s.getElement().addEventListener("blur",
                            function() {
                                t._selectedNode && t.updateNode(n, s.getValue(), i, o)
                            }), s.getElement().addEventListener("keyup",
                            function(e) {
                ...
                C.prototype.addCatygory = function(e, t) {
                    ...
                    this._categoryInfo.push({
                        ...
                        n.setVPadding(0),
                        n.setVGap(this.vGap),
                        n.getView().style.borderTop = "1px solid rgb(197, 193, 189)",
                        n.addRow([{
                            element: t,
                            background: "rgb(240, 239, 238)"
                        }], [.1], 25),
                        n.getView().addEventListener("click",
                            function(e) {
                                if (e.preventDefault(), e.stopPropagation(), n.getView() === e.target && e.clientY - e.target.offsetTop - o._offsetTop <= 25) {
                                    var t = n.__rowIndex;
                                    o._categoryInfo[t].isExpand ? o.root._rows[t].height = 26 : o.root._rows[t].height = o._categoryInfo[t].expandHeight,
                                        o.root.iv(),
                                        o._categoryInfo[t].isExpand = !o._categoryInfo[t].isExpand
                                }
                            })
                },
                C.TEXT = "text",
            ...
            V.setTopView(k.view),
                V.setTopHeight(38),
                V.setCenterView(g.view),
                V.setLeftView(c.view),
                V.setLeftWidth(200),
                V.setRightView(E.view),
                V.setRightWidth(200);
            var I = {
                view: V
            };
